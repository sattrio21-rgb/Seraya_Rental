...
@section('content')
{{-- Hero Section --}}
<div class="relative bg-blue-600 rounded-2xl overflow-hidden mb-12">
    ...
    <div class="relative px-8 py-16 md:py-24 text-center">
        ...
        <p class="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">Pilihan armada lengkap dengan harga terjangkau. Booking online dalam hitungan menit!</p>
        <a href="{{ route('cars.index') }}" class="inline-flex items-center bg-white text-blue-600 px-8 py-3 rounded-lg font-bold hover:bg-blue-50 transition-colors">
